...
public class responseManifestSalidaV2data {
     ...
     * 
     */
    public responseManifestSalidaV2data() {
    }
     ...
     * @param operador
     */
    public responseManifestSalidaV2data(String origen, String destino, Integer operadorId, Operador operador, Integer estatusId, Estatus estatus, String fechaCreacion, String ocupacionEfectiva, String tiempoEntrega, Integer vehiculoId, Vehiculo vehiculo, Integer id, String folioDespacho, Validador validador) {
        super();
        this.origen = origen;
