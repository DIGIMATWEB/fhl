...
public class responseSetDatosValidador {
    ...
    public responseSetDatosValidador(Integer totalRows, Integer status, String message, String function, String sTiempos) {
        super();
